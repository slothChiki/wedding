...
var UserInfoService = /** @class */ (function () {
    ...
    UserInfoService.prototype.getUserInfoList = function () {
        return __awaiter(this, void 0, void 0, function () {
            var notionData, result, userList, _i, result_1, entity, properties;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        _b = (_a = userMap).set;
                        return [4 /*yield*/, this.notionService.getPropertiesValue(properties['name'], PropertiesType.TITLE)];
                    case 3:
                        _c = [_f.sent()];
                        _e = {
                            idx: entity.id
                    ...
                    case 4:
                        _e.name = _f.sent();
                        return [4 /*yield*/, this.notionService.getPropertiesValue(properties['tel'], PropertiesType.RICH_TEXT)];
                    case 5:
                        _e.tel = _f.sent();
                        _d = Date.bind;
                        return [4 /*yield*/, this.notionService.getPropertiesValue(properties['contactDate'], PropertiesType.DATE)];
                    case 6:
                        //Reflection 쓰고싶다....ㅜㅜㅜㅜ
